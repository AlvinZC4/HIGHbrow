			...
			<div className="container">
				<div className="row">
					...
					<div className="col-lg-8">
						<img className="lady" src="/images/curledup.jpg" />
					</div>
              ...
              <div className="row text-center">
                <div className="col-md-4">
                  <span className="fa-stack fa-4x">
                    ...
                    <p className="text-muted">Create a wishlist for friends to see and shop.</p>
    	      </div>
                ...
                <div className="col-md-4">
                  <span className="fa-stack fa-4x">
                      ...
                      <p className="text-muted">Share your link for your birthday, anniversary, college or for a book club.Share your list anytime of the year!</p>
                </div>
                <div className="col-md-4">
                  <span className="fa-stack fa-4x">
                      <i className="fa fa-circle fa-stack-2x text-primary"></i>
                      ...
                      <p className="text-muted">Just listen out for the doorbell or your email notification that your gift has arrived.</p>
                </div>
              </div>    
